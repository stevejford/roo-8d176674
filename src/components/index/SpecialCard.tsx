  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-lg">
        ...
        <span className="absolute right-2 top-2 z-3 inline-flex h-7.5 w-7.5 items-center justify-center rounded-full bg-white shadow-cw-second xl:h-8 xl:w-8 2xl:h-9 2xl:w-9">
          <svg
